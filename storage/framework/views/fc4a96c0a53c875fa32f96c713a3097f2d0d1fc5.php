    ...
    <div class="modal-dialog text-center">
        <div class="col-sm-8 main-section">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('crear.usuarios')); ?>" class="col-12" method="POST" action="">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\seba1\OneDrive\Escritorio\Trabajo de titulo\Animalitos V\Trabajo-de-titulo\resources\views/general/CrearUsuario.blade.php ENDPATH**/ ?>
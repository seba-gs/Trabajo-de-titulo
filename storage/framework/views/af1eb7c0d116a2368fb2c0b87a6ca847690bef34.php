        ...
        <div class="modal-content">
            ...
            <form action="" class="col-12" method="POST">
                ...
                <div class="form-group" id="nombre-group">
                    <input type="text" class="form-control" value="<?php echo e($videos -> nombre); ?>" name="Nombre" maxlength="20">
                </div>
                <div class="form-group" id="descripcion-group">
                    <input type="text" class="form-control" value="<?php echo e($videos -> descripcion); ?>" name="Descripcion" maxlength="200">
                </div>
